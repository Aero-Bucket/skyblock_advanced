...
# near
execute at @s run setblock ^-1 ^ ^1 minecraft:end_portal_frame[facing=south]
execute at @s run setblock ^ ^ ^1 minecraft:end_portal_frame[facing=south]
execute at @s run setblock ^1 ^ ^1 minecraft:end_portal_frame[facing=south]

# far
execute at @s run setblock ^-1 ^ ^5 minecraft:end_portal_frame[facing=north]
execute at @s run setblock ^ ^ ^5 minecraft:end_portal_frame[facing=north]
execute at @s run setblock ^1 ^ ^5 minecraft:end_portal_frame[facing=north]
